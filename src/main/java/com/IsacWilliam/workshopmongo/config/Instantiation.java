package com.IsacWilliam.workshopmongo.config;
...
import com.IsacWilliam.workshopmongo.dto.AuthorDTO;
import com.IsacWilliam.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c3 = new CommentDTO("Tenha um ótimo dia!", sdf.parse("23/23/2018"), new AuthorDTO(alex));
